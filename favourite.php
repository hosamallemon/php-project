...
if(isset($_GET['itemid'])){
    ...
    $sql="delete  from favourite where item_id='".$itemid."'";
...
<html lang="en">
          ...
          $(document).on('click' , '.delete' ,function(){
                  ...
                  $.ajax({
                      ...
                      data:{
                          ...
                          favourite_itemid:$(this).attr('val')
 ...
 <?php include 'head.php' ;?>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index1.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="row no-gutters products">
        ...
        $sql    = "select * from favourite inner join items on favourite.item_id=items.id where favourite.user_id='".$userid."' " ;
        ...
        </a><button  class='btn btn-primary height-auto btn-sm delete' id='delete' val='".$row['id']."' onclick='checkValue(this);'>X</button>
      </div>
