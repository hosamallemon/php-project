              ...
              <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $userid=$_SESSION['user_id'];
                        ...
                        $sql = "select * from cart inner join items on cart.item_id=items.id where cart.user_id='".$userid."'  ";
                ...
                echo"
                  ...
                  <tr>
                    <td class='product-thumbnail'>
                      <img src='uploads/".$row['image']."' alt='Image' class='img-fluid'>
                    </td>
                    ...
                    <td>$49.00</td>
                    <td><a href='cart.php?itemid=".$row['id']."' class='btn btn-primary height-auto btn-sm'>X</a></td>
                  </tr>
                    "; 
